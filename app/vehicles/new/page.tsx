...
export default async function NewVehiclePage({ searchParams }: { searchParams: Promise<{ customerId?: string }> }) {
  ...
  const customers = await customerOptions(context.shop.id, customerId);
